...
var grammar = {
    ...
    {"name": "MAIN", "symbols": ["MAIN$ebnf$1", "REST", "MAIN$ebnf$2"], "postprocess": function(d) { return Object.assign({}, d[1]); }},
    ...
    {"name": "CHANGES", "symbols": [(lexer.has("CATEGORY") ? {type: "CATEGORY"} : CATEGORY), "CHANGES$ebnf$1", (lexer.has("COLON") ? {type: "COLON"} : COLON), "CHANGES$ebnf$2", "ENTRIES", "CHANGES$ebnf$3", "CHANGES"], "postprocess": function(d) { return [[{"category":d[0], "entries": d[4]}], ...d[6]]; }},
    ...
    {"name": "HEADER", "symbols": [(lexer.has("HASH") ? {type: "HASH"} : HASH), (lexer.has("HASH") ? {type: "HASH"} : HASH), "HEADER$ebnf$1", (lexer.has("VERSION") ? {type: "VERSION"} : VERSION), "HEADER$ebnf$2", "DATE_REL", "HEADER$ebnf$3"], "postprocess": function(d) { return {"version":d[3], "date":d[5]};}},
    ...
    {"name": "ENTRY", "symbols": [(lexer.has("DESCRPT") ? {type: "DESCRPT"} : DESCRPT), "ENTRY$ebnf$1", (lexer.has("PR") ? {type: "PR"} : PR)], "postprocess": function(d) { return {"description":d[0], "pr":d[2]}; }},
